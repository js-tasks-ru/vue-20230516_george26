<template>
  <div class="input-group" :class="{'input-group_icon': hasIcons, 'input-group_icon-left': !!$slots['left-icon'], 'input-group_icon-right': !!$slots['right-icon']}">
    ...
    />
    <div :class="{'input-group__icon': hasIcons }">
